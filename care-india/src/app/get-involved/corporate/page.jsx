...
export default function CorporateEngagementsPage() {
  ...
  const [form, setForm] = useState({
    ...
    collaborationType: "", contactPerson: "", mobile: "", email: "", collaborationArea: "", notes: ""
  });
        ...
        >
          <div className="flex items-center justify-between">
            <nav className="text-sm text-gray-600">
              ...
              <span className="mx-2 text-gray-300">›</span>
              <span className="font-medium text-gray-800">Corporate Engagements</span>
            </nav>
        ...
        <main className="max-w-4xl mx-auto px-6 mt-2 mb-16">
          ...
          >
            <div>
              ...
              >
                Form to apply for Corporate Engagements
              </h1>
              <p className="mt-2 text-sm text-gray-600">Tell us how your company would like to engage or partner with our NGO.</p>
            </div>
          </motion.header>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input name="collaborationType" value={form.collaborationType} onChange={handleChange} placeholder="CSR / Volunteering / Skills" className="mt-1 w-full rounded-lg p-3 border border-gray-100" />
                  </div>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Collaboration Area</label>
                  <input name="collaborationArea" value={form.collaborationArea} onChange={handleChange} placeholder="Education, Health, Livelihoods" className="mt-1 w-full rounded-lg p-3 border border-gray-100" />
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-700">Additional Details</label>
                  <textarea name="notes" value={form.notes} onChange={handleChange} rows="4" placeholder="Any additional context or requirements" className="mt-1 w-full rounded-lg p-3 border border-gray-100" />
                </div>
